...
\restrict Be29s4UbdRpSy9RgYPcDjDeO316xCS4ti3Th50vfgRhb7N8bC5uf7dNpQMyxNgo
...
CREATE TABLE public.comercial_representantes (
    ...
    created_at timestamp with time zone DEFAULT now(),
    updated_at timestamp with time zone,
    comissao_padrao integer DEFAULT 0 NOT NULL,
    email character varying,
    telefone character varying
);
...
COPY public.configuracoes_vendas (id, desconto_tipo, considerar_taxa_cartao, dias_vencimento_padrao, imprimir_vendedor, imprimir_observacoes, desconto_maximo_sem_aprovacao) FROM stdin;
1	VALOR	f	30	t	t	\N
\.
...
COPY public.contas_financeiras (id, tipo, status, descricao, valor, data_emissao, data_vencimento, data_pagamento, pedido_id, cliente_id, observacoes, categoria_id, conta_bancaria_id) FROM stdin;
1	RECEBER	PAGO	01	1102	2026-06-30 17:49:27.094848+00	2026-06-30 00:00:00+00	2026-06-30 14:49:40.038085+00	\N	\N	\N	\N	\N
\.
...
COPY public.pedidos_venda (id, cliente_nome, data_pedido, status, valor_total, observacoes, tipo, cliente_id, representante_id, vendedor_interno_id, condicao_pagamento_id, valor_frete, desconto_valor, codigo_rastreio, url_rastreio, transportadora, proposta_id, peso_bruto, peso_liquido, volumes, status_separacao) FROM stdin;
1	Cliente Teste Novo Pedido	2026-06-26 17:28:22.542291+00	RASCUNHO	110.5	Teste automatizado	PEDIDO	6	\N	1	\N	15.5	5	\N	\N	\N	\N	0	0	1	PENDENTE
2	Cliente Teste	2026-06-26 17:45:12.239326+00	RASCUNHO	0		COTACAO	5	\N	1	\N	0	0	\N	\N	\N	\N	0	0	1	PENDENTE
\.
...
14411	Produto de Teste Frontend	SKU-FRONT-001		METALURGICA	UN	\N	\N		0	0	0	t	2026-07-01 10:59:20.023288+00	\N	Simples	0		0	0	0	Pacote / Caixa	0	0	0	t	f	0		\N	0	1	1	t	\N	\N	\N	\N	\N	\N	0	\N
\.
...
SELECT pg_catalog.setval('public.categorias_financeiras_id_seq', 1, false);
...
\unrestrict Be29s4UbdRpSy9RgYPcDjDeO316xCS4ti3Th50vfgRhb7N8bC5uf7dNpQMyxNgo

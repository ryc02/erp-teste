...
\restrict Ig2LZQMn41RHfanKm8jIGibbeLgJgl7UqrSnOUeUC7Bhs7dDy6HeegYJNyl01hp
...
COPY public.pedidos_venda (id, cliente_nome, data_pedido, status, valor_total, observacoes) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.auditoria_logs_id_seq', 7, true);
...
\unrestrict Ig2LZQMn41RHfanKm8jIGibbeLgJgl7UqrSnOUeUC7Bhs7dDy6HeegYJNyl01hp

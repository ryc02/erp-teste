...
\restrict DPYUjOT7siTPPkPiPjEG5OhhYw5zDK8EhjxSNRULE3YHjnPbIdSnZydE9bUaQLS
...
COPY public.pedidos_venda (id, cliente_nome, data_pedido, status, valor_total, observacoes, tipo, cliente_id, representante_id, vendedor_interno_id, condicao_pagamento_id, valor_frete, desconto_valor) FROM stdin;
1	Cliente Teste Novo Pedido	2026-06-26 17:28:22.542291+00	RASCUNHO	110.5	Teste automatizado	PEDIDO	6	\N	1	\N	15.5	5
2	Cliente Teste	2026-06-26 17:45:12.239326+00	RASCUNHO	0		COTACAO	5	\N	1	\N	0	0
\.
...
SELECT pg_catalog.setval('public.auditoria_logs_id_seq', 14, true);
...
SELECT pg_catalog.setval('public.produtos_id_seq', 14410, true);
...
\unrestrict DPYUjOT7siTPPkPiPjEG5OhhYw5zDK8EhjxSNRULE3YHjnPbIdSnZydE9bUaQLS
